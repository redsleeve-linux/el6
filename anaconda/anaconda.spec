...
Patch1004: anaconda-13.21.254_arm.patch
...
%patch1003 -p1 -b .1003
%ifarch %{arm}
#Fonts not available on ARM platforms
%patch1004 -p1 -b .1004
%endif
...
%changelog
* Tue Aug 30 2016 Bjarne Saltbaek <bjarne@redsleeve.org> - 13.21.254-2
- Added patch 1004 for building on ARM
- Patch based on patch from rhbz#743429
