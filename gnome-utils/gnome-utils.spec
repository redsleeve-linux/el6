...
Patch10001:	gnome-utils-2.28.1-GTK_WIDGET_TOPLEVEL.patch
...
%ifarch %{arm}
%patch10001 -p0 -b .GTK_WIDGET_TOPLEVEL
%endif
...
%build
%ifarch %{arm}
export LDFLAGS="$LDFLAGS -lm -lX11"
%endif
%configure \
%ifnarch %{arm}
...
%changelog
* Thu Oct 20 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 2.28.1-10.0
