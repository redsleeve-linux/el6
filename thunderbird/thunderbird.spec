...
%if %{build_langpacks}
Source1:        thunderbird-langpacks-%{version}%{?ext_version}-20160929.tar.xz
%endif
...
Source501:      thunderbird-centos-default-prefs.js.el5
...
%changelog
* Mon Oct  3 2016 Johnny Hughes <johnny@centos.org> - 45.4.0-1
- CentOS Debranding
