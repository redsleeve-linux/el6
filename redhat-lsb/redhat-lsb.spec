...
Summary: LSB base libraries support for Redsleeve 
Name: redhat-lsb
Version: 4.0
...
components required by the LSB that are provided by Redsleeve 
...
%package graphics
Group: System Environment/Base
Summary: LSB graphics libraries support for Redsleeve
...
%package printing
Group: System Environment/Base
Summary: LSB printing libraries support for Redsleeve
...
%post
# make this softlink again for /emul
  if [ -f /emul/arm-linux/lib/%{ldso} ]; then
    for LSBVER in %{lsbsover}; do
      /sbin/sln /emul/arm-linux/lib/%{ldso} /%{_lib}/%{lsbldso}.$LSBVER || :
    done
  fi
%endif
...
%changelog
* Thu Sep 15 2016 Bjarne Saltbaek <bjarne@redsleeve.org> - 4.0-7.el6.redsleeve
- Backported version 4.1.1 to this version (add arm support)
- Added Redsleeve branding
