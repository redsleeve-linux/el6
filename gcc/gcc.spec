...
# Redsleeve
#Patch10001: debian-gcc-linaro-modified.patch
Patch10002: arm-boehm-gc-locks.diff
#Patch10002: debian-rename-info-files-modified.patch
#Patch10003: debian-pr25509-doc-modified.patch
#Patch10004: debian-gcc-linaro-doc-modified.patch
#Patch10005: debian-texinfo-fixes.patch
#Patch10006: debian-gcc-textdomain.patch
#Patch10007: gcc-driver-extra-langs.diff
#Patch10008: gcc-hash-style-gnu.diff
#Patch10009: libstdc++-pic.diff
#Patch10010: debian-libstdc++-doclink-modified.patch
#Patch10011: libstdc++-man-3cxx.diff
#Patch10012: libjava-stacktrace.diff
#Patch10013: debian-libjava-subdir-modified.patch
#Patch10014: libjava-jnipath.diff
#Patch10015: libjava-sjlj.diff
#Patch10016: libjava-disable-plugin.diff
#Patch10017: alpha-no-ev4-directive.diff
#Patch10018: boehm-gc-getnprocs.diff
#Patch10019: note-gnu-stack.diff
#Patch10020: pr25509.diff
#Patch10021: pr38333.diff
#Patch10022: gcc-cloog-dl.diff
#Patch10023: libgomp-omp_h-multilib.diff
#Patch10024: sparc-force-cpu.diff
#Patch10025: gcc-stack_chk_fail-check.diff
#Patch10026: sh4_atomic_update.diff
#Patch10027: libstdc++-arm-wno-abi.diff
Patch10028: gold-and-ld.diff
#Patch10029: libstdc++-test-installed.diff
#Patch10030: pr40816.diff
#Patch10031: gnat-snapshot-build-fix.diff
#Patch10032: gcc-java-align-data.diff
#Patch10033: linux-atomic-builtin-expect.diff
#Patch10034: mips-fix-loongson2f-nop-linaro.diff
#Patch10035: gcc-system-root.diff
#Patch10036: debian-no_fpr_in_libgcc-modified.patch
#Patch10037: pr44364.diff
#Patch10038: debian-gcc-lfs-modified.patch
#Patch10039: pr50090.diff
Patch10040: arm-dynamic-linker.diff
#Patch10041: linux-3.8-compat.diff
#Patch10042: pr45112.diff
Patch10043: gold-and-ld-doc.diff
#Patch10044: pr39491.diff
#Patch10045: deb-protoize.diff
#Patch10046: gcc-d-lang.diff
Patch10047: libstdc++-arm-no-check.diff
Patch10048: debian-gcc-arm-earlyclobbers-modified.patch
#Patch10049: debian-gcc-ice-hack-modified.patch
#Patch10050: gcc-ice-apport.diff
#Patch10051: libjava-disable-static.diff
#Patch10052: libjava-fixed-symlinks.diff
#Patch10053: ada-mips.diff
#Patch10054: debian-gcc-multiarch-modified.patch
#Patch10055: gcc-multiarch-linaro.diff
#Patch10056: libjava-multiarch-linaro.diff
#Patch10057: debian-gcc-powerpc-nof-modified.patch
Patch10058: libjava-nobiarch-check.diff
#Patch10059: config-ml.diff
#Patch10060: s390-biarch.diff
#Patch10061: mips-triarch.diff
#Patch10062: gcc-default-format-security.diff
#Patch10063: gcc-default-fortify-source.diff
#Patch10064: debian-gcc-default-relro-modified.patch
#Patch10065: testsuite-hardening-format.diff
#Patch10066: testsuite-hardening-fortify.diff
#Patch10067: testsuite-hardening-printf-types.diff
#Patch10068: gcc-default-ssp.diff
...
%changelog
* Mon Oct 24 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 4.4.7-17.5
...
* Sun Oct 23 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 4.4.7-17.4
- DP: Fix boehm-gc build on ARM --with-mode=thumb

* Sat Oct 22 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 4.4.7-17.3
- Gold GCC building enabled for ARM

* Fri Oct 21 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 4.4.7-17.2
- Added some Debian patches

* Sat Oct 08 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 4.4.7-17.1
- Added missing arm_neon.h for ARM builds

* Mon Sep 05 2016 Bjarne Saltbaek <bjarne@redsleeve.org> 4.4.7-17.0
- Added patch from Jacco
- Add triplet patch for ARM (Debian #621083)
- libgcc_s.so symlink fix for ARM.
