# if building in mock set with_check 0 null since test suite will fail
%global with_check 0
...
%changelog
* Thu Sep 08 2016 Bjarne Saltbaek <bjarne@redsleeve.org> - 7.19.7-53
- added with_check option
