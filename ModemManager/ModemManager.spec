...
Patch3: ModemManager-0.4-fix-new-glib.patch
...
%changelog
* Sun Sep 18 2016 Bjarne Saltbaek <bjarne@redsleeve.org> - 0.4.0-5.git20100628.0
- Added patch to fix glib build error.
